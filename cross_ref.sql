...
CREATE PROCEDURE cross_ref @gene varchar(20), @margin numeric
  ...
  SELECT a.gene_name, a.chr_start-@margin, c.bp, a.chr_end,
  ...
  SELECT a.gene_name, a.chr_start-@margin, d.bp, a.chr_end,
  ...
  SELECT a.gene_name, a.chr_start-@margin, e.bp, a.chr_end,
  ...
  SELECT a.gene_name, a.chr_start-@margin, f.bp, a.chr_end,
  ...
  SELECT a.gene_name, a.chr_start-@margin, g.bp, a.chr_end,
  ...
  SELECT a.gene_name, a.chr_start-@margin, h.bp, a.chr_end,
  ...
  SELECT a.gene_name, a.chr_start-@margin, i.bp, a.chr_end,
         i.chr, i.beta, i.p_value, i.trait
  FROM   [dbo].[hg19] as a,
         [dbo].[Lipid_Japanese_lipid_trait_Kanai_NG] as i
  WHERE  (a.gene_name = @gene) and (i.bp between a.chr_start-@margin and a.chr_end+@margin)

                          UNION

  SELECT a.gene_name, a.chr_start-@margin, j.bp, a.chr_end,
  ...
  SELECT a.gene_name, a.chr_start-@margin, k.bp, a.chr_end,
  ...
  SELECT a.gene_name, a.chr_start-@margin, l.bp, a.chr_end,
  ...
  SELECT a.gene_name, a.chr_start-@margin, m.bp, a.chr_end,
